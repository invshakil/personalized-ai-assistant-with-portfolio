...
async function main() {
  ...
  // ─── Former tenant: Mary Wilson (occupied Flat 2D before Thomas Moore) ───────────────
  ...
  //
  // T01 James Brown  — 3 payments (Mar, Apr, May 2026) — moved in Mar 1 2026
  // T02 William Jones   — 2 payments (Apr, May 2026) — moved in Apr 2024, no Mar record in Excel
  // T03 Richard Miller   — 2 payments (Apr, May 2026) — moved in Apr 1 2026
  // T00 Mary Wilson  — 2 payments (Mar, Apr 2026) — former T04, vacated Flat 2D before Jun 2026
  //
  // Note: Mary Wilson's Mar payment shows amountPaid=7000 vs rentDue=8500 in Excel,
  ...
  const paymentHistory: {
    ...
    // ── T00 Mary Wilson (former T04, Flat 2D) ──
    {
      tenantCode: "T00",
      unitNumber: "Flat 2D",
      month: 3,
  ...
  // All payments are caretaker salary (Mr. Walker), ৳13,000/mo, paid in cash.
  ...
  console.log("   Note: Mary Wilson (T00) Mar+Apr payments show amountPaid=৳7000 vs rentDue=৳8500");
