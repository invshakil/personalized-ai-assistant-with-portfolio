...
async function main() {
  ...
  await db.$transaction(
    async (tx) => {
      ...
      // ── Current tenants ────────────────────────────────────────────────────
      const tenantData = [
        { tenantCode: "T01", name: "Sharif",   phone: "01322-231218", unitNumber: "Flat 4E", moveInDate: new Date("2026-03-01"), leaseEndDate: new Date("2027-12-31"), monthlyRent: 7000,  advancePaid: true,  advanceAmount: 7000, notes: null },
        { tenantCode: "T02", name: "Faruk",    phone: "01829-737266", unitNumber: "Flat 4D", moveInDate: new Date("2024-04-01"), leaseEndDate: new Date("2027-12-31"), monthlyRent: 9500,  advancePaid: false, advanceAmount: 0,    notes: null },
        { tenantCode: "T03", name: "Mintu",    phone: "01730-872119", unitNumber: "Flat 5A", moveInDate: new Date("2026-04-01"), leaseEndDate: new Date("2027-12-31"), monthlyRent: 5000,  advancePaid: true,  advanceAmount: 4500, notes: null },
        { tenantCode: "T04", name: "Foyez",    phone: "01731-301216", unitNumber: "Flat 2D", moveInDate: new Date("2026-06-01"), leaseEndDate: new Date("2027-06-29"), monthlyRent: 8500,  advancePaid: true,  advanceAmount: 6000, notes: null },
        { tenantCode: "T05", name: "Alamin",   phone: "01871001478",  unitNumber: "Flat 2A", moveInDate: new Date("2026-07-01"), leaseEndDate: new Date("2027-06-29"), monthlyRent: 9000,  advancePaid: true,  advanceAmount: 9000, notes: "Rent increase ৳500 effective July 1, 2026" },
        { tenantCode: "T06", name: "Kamrul",   phone: "01759363407",  unitNumber: "Flat 2E", moveInDate: new Date("2026-06-01"), leaseEndDate: new Date("2027-06-29"), monthlyRent: 7000,  advancePaid: true,  advanceAmount: 7000, notes: null },
        { tenantCode: "T07", name: "Ashraful", phone: "01810155335",  unitNumber: "Flat 2C", moveInDate: new Date("2026-07-01"), leaseEndDate: new Date("2027-06-29"), monthlyRent: 8000,  advancePaid: true,  advanceAmount: 8000, notes: null },
      ];
      ...
      for (const e of expenseHistory) {
        const existing = await tx.expense.findFirst({ where: { month: e.month, year: e.year, paidTo: "Kaku", category: ExpenseCategory.SALARY } });
        if (!existing) {
          await tx.expense.create({
            data: { description: "Monthly caretaker salary", amount: 13000, currency: "BDT", category: ExpenseCategory.SALARY, month: e.month, year: e.year, expenseDate: e.expenseDate, paidTo: "Kaku", paymentMode: "Cash", notes: "Fixed monthly caretaker payment" },
          });
        }
      }
  ...
  console.log("   Note: Nasrin (T00) Mar+Apr payments show amountPaid=৳7,000 vs rentDue=৳8,500");
