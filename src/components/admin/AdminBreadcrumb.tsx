...
const routeLabels: Record<string, string> = {
  ...
  "/admin/reports/financial": "Financial Tracker Reports",
  "/admin/reports/property": "Property Reports",
  "/admin/renovation": "Renovation",
  "/admin/ai-assistant": "AI Assistant",
  "/admin/settings": "Settings",
  "/admin/settings/appearance": "Appearance",
  "/admin/settings/defaults": "Form Defaults",
  "/admin/settings/backup": "Backups",
