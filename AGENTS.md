...
**The rule in one sentence:** page files wire hooks to components — they contain neither logic nor markup blocks.

See `CLAUDE.md → Coding standards → Component structure & decomposition` for thresholds, the co-location directory layout, the orchestrator pattern, and the canonical reference implementation.
