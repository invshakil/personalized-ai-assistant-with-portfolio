...
- **Income sources (clients):** `MapX` (৳31,990,894 / 92 payments — primary), `DevArena+DevCourt`
  (৳4,347,236 / 24), `Freelance project` (৳967,140 / 13), `Incentive` (৳52,449 / 7).
...
- **Employees:** Tanvir Reza Anik (৳1,593,600 / 44), Rashidul Islam (৳1,710,810 / 11),
  Mayenuddin Kabir (৳745,500 / 14), Shafayet Bayejid (৳88,500 / 5).
- **Employee payment `Reference`** = funding client/source (savannah, christoph, ahsan, Habib…) —
...
| 10 | Dashboard **date-range filter** — This month / Last 3 / Last 6 / Last 1yr / Last 2yr / This FY (default) / All | ✅ done (2026-06-13) — `getFinanceDashboard({from,to})`; verified June-2026=৳0, FY=৳14,569,790, All=৳37,357,719 |
...
| Check | Expected |
| ----- | -------- |
| Total income, all FYs | ৳37,357,719 |
| FY 2023-2024 income | ৳9,450,013 |
| FY 2024-2025 income | ৳13,337,916 |
| FY 2025-2026 income | ৳14,569,790 |
| MapX total | ৳31,990,894 (92 rows) |
| Tanvir total paid | ৳1,593,600 (44 rows) |
| Rashidul total paid | ৳1,710,810 (11 rows) |
